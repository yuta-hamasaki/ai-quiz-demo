...
さらに、自身が語学学習を進める中で、日本人は他国の語学学習者と比べてアウトプット量が不足しがちであることに気づきました。そこで、日本語から他の言語へ瞬時に訳すトレーニングと、AI によるフィードバックを組み合わせることで、より効率的に学習できるようになりました。
...
| カテゴリ | 技術 | 採用理由 |
| :--- | :--- | :--- |
| **フロントエンド　・　バックエンド** | Next.js (App Router) | 同じコードベースで開発できるため|
